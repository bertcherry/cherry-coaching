  ...
  return (    
    <>
        <div className={styles.homeDisplay}>
            ...
            <Link className={styles.btn} href='/interest'>Get in Touch</Link>
            ...
            <div>Fill out the interest form and I'll do my best to be in touch within 48 hours. Not sure which option is the right fit? We'll talk through it together.</div>
            <Link className={styles.btn} href='/interest'>Fill Out the Interest Form</Link>
        </div>
    </>
)
}