// .wrangler/.wrangler/tmp/bundle-h0d4GP/checked-fetch.js
...
// .wrangler/tmp/pages-riFEsF/functionsWorker-0.8462312247825194.mjs
...
var articles = [
  {
    ...
    text: "Hello world! This is my first article on my new Cloudflare Workers + Pages blog.",
    published_at: /* @__PURE__ */ new Date("2020-10-23")
  },
  {
    id: 2,
    title: "Updating my blog",
    text: "It's my second article! I'm still writing and publishing using Cloudflare Workers + Pages :)",
    published_at: /* @__PURE__ */ new Date("2020-10-26")
  }
];
var data_default = articles;
function onRequestGet(context) {
  const id = context.params.id;
  if (!id) {
    return new Response("Not found", { status: 404 });
  }
  const article = data_default.find((article2) => article2.id === Number(id));
  if (!article) {
    return new Response("Not found", { status: 404 });
  }
...
// .wrangler/.wrangler/tmp/bundle-h0d4GP/middleware-insertion-facade.js
...
// .wrangler/.wrangler/tmp/bundle-h0d4GP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8462312247825194.js.map
