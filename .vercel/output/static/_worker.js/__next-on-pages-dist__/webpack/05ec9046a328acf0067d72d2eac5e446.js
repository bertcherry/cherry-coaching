...
`)}}}),p={};((e,t)=>{for(var n in t)i(e,n,{get:t[n],enumerable:!0})})(p,{getOptionalRequestContext:()=>g,getRequestContext:()=>E}),u.exports=c(i({},"__esModule",{value:!0}),p),b(1223);var f=((e,t,n)=>(n=e!=null?x(j(e)):{},c(!t&&e&&e.__esModule?n:i(n,"default",{value:e,enumerable:!0}),e)))(C()),w=Symbol.for("__cloudflare-request-context__");function g(){let e=v[w];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(f.default`
		...
		`);return e}function E(){let e=g();if(!e)throw process?.env?.NEXT_PHASE==="phase-production-build"?Error(f.default`
			...
			`):Error("Failed to retrieve the Cloudflare request context.");return e}},l.__chunk_5430=u=>{u.exports={videoDisplay:"Videos_videoDisplay__PtcpB",videoContainer:"Videos_videoContainer__ESUjU",videosContainer:"Videos_videosContainer__N39Mp",videosList:"Videos_videosList__XCURK"}},l);export{N as __getNamedExports};
